<!-- Anupta Argo | Princeton University | MS Computer Science | Vector Databases, Systems Research -->
...
```bash
portfolio  →  anuptaa.github.io
linkedin   →  linkedin.com/in/anupta-argo
email      →  anupta@princeton.edu
leetcode   →  leetcode.com/anupta
```
